...
`generated/com/.dynwinrt-com-manifest.json`, currently version 3. Within the
...
**PR1 upgrade requirement:** version 3 replaces version 2 because every
generated safe COM class now registers a descriptor for `projectAs` and typed
endpoint activation. Delete the existing generated bindings directory and
