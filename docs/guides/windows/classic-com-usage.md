...
`generated/com/.dynwinrt-com-manifest.json`, currently version 4. Within the
...
and typed endpoint activation. Borrowed-copy support requires version 4 so
every selected audio initialization/GetService wrapper carries its context
effects. Delete the existing generated bindings directory and
...
COM manifest **4** / unsafe support schema **12**, delete the old generated output and regenerate it in
full; do not combine old audio initialization wrappers with new copy facades.
