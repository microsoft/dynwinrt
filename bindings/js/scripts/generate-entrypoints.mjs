...
writeFileSync(join(distDir, 'win32-internal.js'), [
  ...
  '  const aggregate = new RecoveryAggregateError([value, error], "Win32 cleanup error projection failed", { cause: value })',
  '  defineProperties(aggregate, {',
  '    cleanupFailures: { get: () => cleanupFailures(value) },',
  '    retryCleanup: { value: () => native.win32CallErrorRetryCleanup(value) },',
  '  })',
  '  return aggregate',
  '}',
...
const carrierMembers = [
  ...
  ['readonly cleanupFailures: readonly DynWin32CleanupFailure[]', 'retryCleanup(): void'],
]
