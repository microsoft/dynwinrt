...
import {
  ...
  getProcAddress,
  loadLibraryW,
} from "../../e2e_generated/win32/win32/windows/win32/system/library-loader/Apis.js";
import { ldapGetLastError } from "../../e2e_generated/win32/win32/windows/win32/networking/ldap/Apis.js";
import { getAdaptersAddresses } from "../../e2e_generated/win32/win32/windows/win32/network-management/ip-helper/Apis.js";
import {
  createPOINT,
  createRECT,
  ptInRect,
