...
import {
  ...
  wsaGetLastError,
  wsaSetLastError,
} from "../../e2e_generated/win32/win32/windows/win32/networking/win-sock/Apis.js";
import {
  gdipGetImageDecodersSize,
  initializeGdiPlus,
} from "../../e2e_generated/win32/win32/windows/win32/graphics/gdi-plus/Apis.js";
import {
  initializeMediaFoundation,
  mfGetTimerPeriodicity,
} from "../../e2e_generated/win32/win32/windows/win32/media/media-foundation/Apis.js";
