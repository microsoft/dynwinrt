...
class WwwFormUrlDecoderLike(_WwwFormUrlDecoderIdentity, Protocol):
    ...
    @overload
    def __getitem__(self, index: slice) -> list[IWwwFormUrlDecoderEntry]: ...
...
class WwwFormUrlDecoder(_WwwFormUrlDecoderIdentity, Sequence[IWwwFormUrlDecoderEntry], _DynWinRTRuntimeClass):
...
class IVectorView_IWwwFormUrlDecoderEntry(Sequence[IWwwFormUrlDecoderEntry]):
...
class IIterable_IWwwFormUrlDecoderEntry(Iterable[IWwwFormUrlDecoderEntry]):
    def __init__(self, obj: DynWinRTValue) -> None: ...
    @builtins.property
    def _obj(self) -> DynWinRTValue: ...

    def __iter__(self) -> Iterator[IWwwFormUrlDecoderEntry]: ...
