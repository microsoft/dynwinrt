...
const { DynCom, DynComMethodSig, DynWinRtValue, WinGuid, __registerComProjection, __comProjectionIid, projectAs } = require('@microsoft/dynwinrt/com/unsafe');
...
__registerComProjection(IDataTransferManagerInterop, IID_IDataTransferManagerInterop);
