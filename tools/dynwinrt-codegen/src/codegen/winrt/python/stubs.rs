...
fn import_line(context: &PythonProjectionContext) -> String {
    ...
    let object_value_alias = context.support_symbol_import(PythonSupportSymbol::WinRTObjectValue);
    let object_input_alias = context.support_symbol_import(PythonSupportSymbol::WinRTObjectInput);
    format!(
        "\
import builtins
from ._typing import (
    ...
    {object_input}, {object_value_alias}, {object_input_alias}, _DynWinRTProjector,
)\n"
    )
}
...
from dynwinrt import (\n\
    ...
    WinRTObjectInput as WinRTObjectInput, WinRTObjectValue as WinRTObjectValue,\n\
