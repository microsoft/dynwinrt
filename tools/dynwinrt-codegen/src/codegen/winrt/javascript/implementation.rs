...
fn project_validated(
    ...
    let factory_declarations = format!(
        "    /** Validate synchronous handlers and create an independent interface descriptor.{requirements} */\n    static implementation(handlers: {}Handlers): DynWinRtImplementationDescriptor;\n    /** Create a non-agile owner-thread implementation. The controller is separate from this wrapper.{requirements} */\n    static implement(handlers: {}Handlers, ...additional: DynWinRtImplementationDescriptor[]): DynWinRtImplementation;\n    /** Query a controller for this interface and return an owned, typed view. */\n    static fromImplementation(owner: DynWinRtImplementation): {};\n",
